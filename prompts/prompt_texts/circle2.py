...
'''
CIRCLE 2, THE CIRCLE OF ILLUSTRATIONS:
- Provide base example of how to compute the value of an allocation/offer
'''

def make_prompt_circle_2(T: int, quantities: list[int], V: int, values: list[float], W1: int, W2: int, w: int, R: int, g: float, r: int, history: dict, current_offer: Offer = None, player_num: int = 0, p1_outside_offer: list[int] = None, p2_outside_offer: list[int] = None, circle: int = 0, other_player_num: int = 0, my_player_num: int = 0) -> str:
    return f"""
